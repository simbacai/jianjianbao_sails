...
function grantRegisteredPermissions (roles, models, admin) {
  ...
  var permissions = [
    ...
    //ProposalSummary permission granted to registered user
    {
      model: _.find(models, { name: 'ProposalSummary' }).id,
      action: 'read',
      role: registeredRole.id,
      createdBy: admin.id,
      relation: 'role' 
    ...
    //ChatRoom permission granted to registered user
    {
      model: _.find(models, { name: 'ChatRoom' }).id,
      action: 'create',
      role: registeredRole.id,
      createdBy: admin.id,
      relation: 'role'
    ...
    //ChatRecord permission granted to registered user
    {
      model: _.find(models, { name: 'ChatRecord' }).id,
      action: 'create',
      role: registeredRole.id,
      createdBy: admin.id,
      relation: 'role'
