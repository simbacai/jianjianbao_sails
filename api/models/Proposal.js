  ...
  beforeCreate: [
    ...
    */
    function checkPosterStatus (values, next) {
      sails.log.silly('Proposal.beforeCreate.checkPosterStatus', values);
      Poster
  ...
  afterCreate: [
    ...
    */
    function setOwner (proposal, next) {
      sails.log.silly('Proposal.afterCreate.setOwner', proposal);
      Proposal
    ...
    */
    function setAuthOwner (proposal, next) {
      sails.log.silly('Proposal.afterCreate.setAuthOwner');
    ...
    */    
    function connectPoster (proposal, next) {
      sails.log.silly('Proposal.afterCreate.connectPoster');
      Poster.findOne({ id: proposal.poster })
      .then(function (poster) {
    ...
    */    
    function createProposalSummary (proposal, next) {
      sails.log.silly('Proposal.afterCreate.createProposalSummary');
  ...
  beforeDestroy: [
    ...
    */    
    function disconnectPoster (criteria, next) {
      sails.log.silly('Proposal.afterDestroy.disconnectPoster', criteria);
    ...
    */    
    function deleteProposalSummary (criteria, next) {
      sails.log.silly('Proposal.afterDestroy.deleteProposalSummary');
